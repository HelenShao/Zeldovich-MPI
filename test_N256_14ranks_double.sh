#!/bin/bash
# Test script for N=256, 14 ranks - DOUBLE PRECISION
# Version 15.1.2: Tests that matrix output is purely real

echo "========================================"
echo "Testing: N=256, 14 ranks (DOUBLE PRECISION)"
echo "Version: 15.1.2"
echo "Date: $(date)"
echo "========================================"
echo ""
...
mpirun -np 14 ./hermitian_3d_matrix 256 2>&1 | tee v15_1_2_test/test_N256_14ranks_double.log

echo ""
echo "Test complete!"
echo "Check test_N256_14ranks_double.log for output"
echo "========================================"
