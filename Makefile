...
MODULE_SRC = src/fft/fft_setup.c \
             ...
             src/generation/ZD_MPI_generation.c \
...
WISDOM_RANK0_TARGET = wisdom_rank0
...
help:
	@echo ""
	@echo "  make              - Build main executable (Zeldovich_MPI)"
	...
	@echo "  make wisdom-rank0    - Build serial wisdom_rank0 (preflight FFTW wisdom file)"
