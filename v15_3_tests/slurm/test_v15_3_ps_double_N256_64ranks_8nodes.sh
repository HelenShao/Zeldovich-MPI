...
#SBATCH --job-name=v15_3_ps_dbl_N256_64
#SBATCH --output=/scratch/gpfs/hshao/C_Bible/InitialConditions/hermitian_3d_matrix_production/v15_3_tests/test_v15_3_ps_double_N256_64ranks_8nodes.log
#SBATCH --error=/scratch/gpfs/hshao/C_Bible/InitialConditions/hermitian_3d_matrix_production/v15_3_tests/test_v15_3_ps_double_N256_64ranks_8nodes.err
#SBATCH --nodes=8
...
srun -N 8 -n $N_RANKS ./hermitian_3d_matrix $N $PARAM_FILE 2>&1 | tee v15_3_tests/test_v15_3_ps_double_N256_64ranks_8nodes_output.log

echo ""
echo "Checking if output is purely real..."
grep -i "Array.*Max\|RESULT\|purely real" v15_3_tests/test_v15_3_ps_double_N256_64ranks_8nodes_output.log | tail -10

echo ""
echo "Checking precision info..."
grep -i "Precision:" v15_3_tests/test_v15_3_ps_double_N256_64ranks_8nodes_output.log | head -3

echo ""
echo "Checking timing..."
grep -i "TIMING\|Stage.*time\|Total.*time" v15_3_tests/test_v15_3_ps_double_N256_64ranks_8nodes_output.log | tail -10
