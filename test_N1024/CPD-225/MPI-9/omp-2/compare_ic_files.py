...
def main():
    ...
    if len(sys.argv) >= 3:
        ...
        # Default paths for current test directory
        script_dir = os.path.dirname(os.path.abspath(__file__))
        dir1 = os.path.join(script_dir, "particle_ics")
        dir2 = os.path.expanduser("~/InitialConditions/zeldovich-PLT/output_N4_sc_ic")
    
    print("Reading particles from both locations...")
    print(f"Directory 1 (hermitian): {dir1}")
    print(f"Directory 2 (zeldovich): {dir2}")
    print()
