...
#SBATCH --job-name=test_v15_2_ps_dbl_N256_8
#SBATCH --output=/scratch/gpfs/hshao/C_Bible/InitialConditions/hermitian_3d_matrix_production/v15_2_tests/test_v15_2_ps_double_N256_8ranks_1node.log
#SBATCH --error=/scratch/gpfs/hshao/C_Bible/InitialConditions/hermitian_3d_matrix_production/v15_2_tests/test_v15_2_ps_double_N256_8ranks_1node.err
#SBATCH --nodes=1
...
srun -N 1 -n $N_RANKS ./hermitian_3d_matrix $N $PARAM_FILE 2>&1 | tee v15_2_tests/test_v15_2_ps_double_N256_8ranks_1node_output.log

echo ""
echo "Checking if output is purely real..."
grep -i "Array.*Max\|RESULT\|purely real" v15_2_tests/test_v15_2_ps_double_N256_8ranks_1node_output.log | tail -10
