...
#SBATCH --job-name=test_v15_2_ps_dbl_N1024_128
#SBATCH --output=/scratch/gpfs/hshao/C_Bible/InitialConditions/hermitian_3d_matrix_production/v15_2_tests/test_v15_2_ps_double_N1024_128ranks.log
#SBATCH --error=/scratch/gpfs/hshao/C_Bible/InitialConditions/hermitian_3d_matrix_production/v15_2_tests/test_v15_2_ps_double_N1024_128ranks.err
#SBATCH --nodes=4
...
echo "Large Array Test: N=$N, ranks=$N_RANKS, nodes=4"
...
srun ./hermitian_3d_matrix $N $PARAM_FILE 2>&1 | tee v15_2_tests/test_v15_2_ps_double_N1024_128ranks_output.log

echo ""
echo "Checking if output is purely real..."
grep -i "Array.*Max\|RESULT\|purely real" v15_2_tests/test_v15_2_ps_double_N1024_128ranks_output.log | tail -10

echo ""
echo "Checking precision info..."
grep -i "Precision:" v15_2_tests/test_v15_2_ps_double_N1024_128ranks_output.log | head -3

echo ""
echo "Checking timing..."
grep -i "TIMING\|Stage.*time\|Total.*time" v15_2_tests/test_v15_2_ps_double_N1024_128ranks_output.log | tail -10
