...
OUTPUT_DIR="${ZELDOVICH_DIR}/output_rng_k2cutoff_N1024_PLT"
RNG_LOG_DIR="/home/helenshao/InitialConditions/hermitian_3d_matrix_production/test_rng/k2_cutoff/N1024_PLT/rng_logs"

echo "=========================================="
echo "Running zeldovich-PLT with PLT ENABLED (RNG comparison)"
echo "PLT and PLT rescaling ENABLED"
