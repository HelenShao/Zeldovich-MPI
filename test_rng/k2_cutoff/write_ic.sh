...
# Test parameters
N=16
PARAM_FILE="/home/helenshao/InitialConditions/hermitian_3d_matrix_production/test_rng/k2_cutoff/param_N16_rng.par"
BIN_OUTPUT_DIR="test_rng/k2_cutoff/bin_files"
PARTICLE_OUTPUT_DIR="test_rng/k2_cutoff/particle_ics"
RNG_LOG_DIR="test_rng/k2_cutoff/rng_logs"

# Create output directories
mkdir -p test_rng/k2_cutoff
...
./write_particles_from_reassembled_mpi \
    ...
    $I_START \
    $I_END \
    2>&1 | tee test_rng/k2_cutoff/N16_reassembly.log
