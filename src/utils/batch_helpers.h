...
// ====================================================================================
// This file contains functions for calculating batch distributions and MPI
// communication counts for multi-batch processing of Y-slice pairs.
//
...
#endif // HERMITIAN_BATCH_HELPERS_H
